describe('Test Registro web', () => {
  ...
  it('passes', () => {
    ...
    cy.get('[data-cy="input-telefono"]').clear().type('3109292923');
    ...
    cy.wait(1000)
    cy.get('[data-cy="input-email"]').clear().type('daniel@hotmail.com');
    cy.get('[data-cy="input-confirmar-email"]').clear().type('daniel@hotmail.com');
